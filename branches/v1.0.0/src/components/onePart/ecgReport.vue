    ...
    <div class="ecgReport">
      <div class="history_content">
        ...
        <div v-else class="scoreResult">
          {{ data.ecgElectrocardioDetail.heartStatus }}
        </div>
    ...
    <div class="heartHealth">
      <div class v-if="data.healthLevel == -1">
        ...
        <div class="ecg_content ecg_result">
          {{ data.ecgElectrocardioDetail.ecgResult }}
        </div>
      </div>
      <div class v-else>
        <div class="heartStatus ecg_content">
        ...
        <div class="ecg_content pathogeny" v-if="analysisShow">
          ...
          <div class="analysisResults" v-if="paymentShow">
        ...
        <div class="ecg_content pathogeny">
          <div class="t-item_icon">
            <span class="iconWid">
              <!--<van-icon class='healthcare_icon' name="smile-comment-o" />-->
              <img class="healthcare" :src="care" />
            </span>
            <span class="ecg_title">保健建议</span>
          </div>
          <div class="analysisResults" v-if="!analysisShow || paymentShow">
