    ...
    <div class="talkMsg_list">
      ...
      >
        ...
        <div class="item_content">
          ...
          <div class="txt_ellipsis title_type_3">
            {{ item.content | f_img }}
          </div>
        </div>
      </div>
...
export default {
    ...
    async get_list() {
      ...
      try {
        ...
        if (res.data.respHead.respCode === "000") {
          if (
            res.data.body.data.systemMsg === "" &&
            res.data.body.data.talkMsg.length === 0
          ) {
            this.is_no = true;
            return;
          }
          this.systemMsg = res.data.body.data.systemMsg;
  ...
  filters: {
    ...
    f_img(val) {
      return val.indexOf("<img") > -1 ? "[图片]" : val;
    }
  }
};
</script>
