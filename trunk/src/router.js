  ...
  routes: [
    {
      ...
      children: [
        ...
        {
          path: "/historyInterpretation",
          component: resolve =>
            require(["./components/onePart/historyInterpretation.vue"], resolve),
          name: "historyInterpretation",
          meta: {
            title: "心电解读报告",
            requiresAuth: true
          }
        ...
        },
        {
          path: "/hospitalList",
          component: resolve =>
            require(["./components/onePart/hospitalList.vue"], resolve),
          name: "HospitalList",
          meta: {
            title: "医院列表",
            requiresAuth: true
        ...
        },
        {
          ...
          component: resolve =>
          require(["./components/onePart/hospitalDetails.vue"], resolve),
        ...
        // 服务评价
        {
          ...
          component: resolve =>
            require(["./components/onePart/serviceEvaluate.vue"], resolve),
